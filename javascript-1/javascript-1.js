...
classes.forEach(function (currentValue, index, array) {
  currentValue.inPerson = false;
  currentValue.homework = false;
  return classes
})
...
const teachStay = teachTrick.bind(fido.tricks)
...
//CODE HERE
  let phone1 = new Phone ("Nokia", "xqa", 1, "red", false)
  let phone2 = new Phone ("Motorola", "zas", 1, "blue", false)
  let phone3 = new Phone ("iphon", "qwa", 1, "grey", false)
